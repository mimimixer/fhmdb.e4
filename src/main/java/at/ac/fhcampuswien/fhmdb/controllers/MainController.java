...
import at.ac.fhcampuswien.fhmdb.factory_pattern.BaseFactory;
import at.ac.fhcampuswien.fhmdb.factory_pattern.MovieListControllerFactory;
import at.ac.fhcampuswien.fhmdb.factory_pattern.WatchlistControllerFactory;
...
public class MainController {
    ...
    public void setContent(String fxmlPath, BaseFactory factory){
    ...
    public void navigateToWatchlist() {
        setContent(UIComponent.WATCHLIST.path, new WatchlistControllerFactory());
    }

    @FXML
    public void navigateToMovielist() {
        setContent(UIComponent.MOVIELIST.path, new MovieListControllerFactory());
    }
}