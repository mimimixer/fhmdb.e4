...
import at.ac.fhcampuswien.fhmdb.state_pattern.SortedAscendingState;
import at.ac.fhcampuswien.fhmdb.state_pattern.SortedDescendingState;
...
class MovieListControllerTest {
    private static MovieListController homeController;
    @BeforeAll
    static void init() {
        homeController = new MovieListController();
    }
    ...
    void if_not_yet_sorted_sort_is_applied_in_ascending_order() {
        ...
        homeController.sortedState = new NotSortedState(homeController.allMovies);

        // when
        homeController.toggleSorting();
    ...
    void if_last_sort_ascending_next_sort_should_be_descending() {
        ...
        homeController.setMovies(Movie.initializeMovies());
        homeController.setMovieList(Movie.initializeMovies());
        homeController.sortedState = new SortedAscendingState(homeController.allMovies);
    ...
    void if_last_sort_descending_next_sort_should_be_ascending() {
        ...
        homeController.setMovieList(Movie.initializeMovies());
        homeController.setMovies(Movie.initializeMovies());
        homeController.sortedState = new SortedDescendingState(homeController.allMovies);
